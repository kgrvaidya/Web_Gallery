		...
		<h1>
		 	<a href="">Web Gallery</a>
				...
				<ul>
					...
					<li><a href="delvid.php">Update/Delete</a></li>	
		    		<li><a href="">Home</a></li>
...
<!-- PHP Block Starts HERE-->
 ...
 <?php 
  ...
  $servername="localhost";
	...
	$sql = "select Name,url from video2 where uid=$uid";
	...
	<div align="center">
	 <?php 
	 $resulta=mysqli_query($conn, " CALL no_of_vid($uid) ");
	 $row=mysqli_fetch_array($resulta,MYSQLI_BOTH);
	 echo "The number of Videos uploaded by you :" . $row[0]; ?>
	</div>
 <?php
...
?>
  ...
  <source src="<?php printf("%s",$row["url"]);?>" type="video/mp4">
  </video>
